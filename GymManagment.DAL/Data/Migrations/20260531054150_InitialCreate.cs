        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Phone", "Phone LIKE '01[0125]%' AND len(Phone) = 11");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CQ_PlanDuarationCheck", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Email1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("CK_User_Phone1", "Phone LIKE '01[0125]%' AND len(Phone) = 11");
                });
